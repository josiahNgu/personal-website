...
const projectDetails = [
  ...
  },
  {
    ...
    repoLink: 'https://github.com/josiahNgu/BootlegTwitter-And-ConcertWebApp/tree/bootlegTwitter',
    liveLink: '',
    techStack: 'AngularJS,MongoDB, NodeJS, ExpressJS, Javscript, HTML, CSS'
  },
  {
    title: 'Thiner',
    description: 'Thiner is an application that takes a long URL and turns it into a short and easily memorable word. After creating a magic URL, the user can easily share it with their peers and friends where the app will redirect the user to the original link when they use the magic URL. This project involved heavily System Design skills to make a scalable app.',
    repoLink: 'https://github.com/josiahNgu/Thiner',
    liveLink: '',
    techStack: 'MongoDB, ExpressJS, NodeJS, HTML, CSS, JavaScript, Python, AWS Lamda'
  },
]
const project = () => {
  return (
